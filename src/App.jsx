...
import { Wine, Star, Trash2, ArrowRightLeft, X, Plus, Filter, ChevronDown, ChevronUp, Search, Loader2, LogOut } from 'lucide-react';
    ...
    <div className="min-h-screen" style={{ background: '#FAFAFA' }}>
      <header className="px-4 py-6">
        <div className="max-w-md mx-auto flex items-center justify-between">
          ...
          <button onClick={signOut} className="p-2 rounded-full" style={{ background: '#FFFFFF' }}>
            <LogOut className="w-5 h-5" style={{ color: '#722F37' }} />
          </button>
        </div>
      </header>
